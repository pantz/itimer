...
(function($){
	$.itimer = function(el, options){
		...
		base.init = function(){
				...
				if(base.options.background !== null){
					$('.image', base.el).html($('<img />').prop('src', base.options.background));
				}
	...
	$.itimer.defaultOptions = {
		title: null,
		background: null,
		until: new Date()
	};
	
	$.fn.itimer = function(options){
		return this.each(function(){
				(new $.itimer(this, options));
		});
	};
